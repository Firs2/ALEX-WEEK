...
using FIRS.CoreModules.Serialization.Collections;
using FIRS.SystemModules.InventoryModules;
using FIRS.SystemModules.InventoryModules.GroupInventory;
using FIRS.CoreModules.InputSystem;
using System;
using System.Collections.Generic;
using UnityEngine;

namespace FIRS.WeaponModules
{
    [HideScriptField]
    [AddComponentMenu("FIRS/Weapon Modules/Inventory/Weapon Inventory System")]
