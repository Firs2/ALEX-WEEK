...
using FIRS.CoreModules;
using FIRS.CoreModules.ValueTypes;
using FIRS.SystemModules.ControllerSystems;
using FIRS.SystemModules.CameraSystems;
using UnityEngine;
...
{
    [HideScriptField]
    [AddComponentMenu("FIRS/Weapon Modules/Animation/Weapon Animator System")]
